...
public class RecipeListFragment extends Fragment implements RecipeListAdapter.OnRecipeClickListener, RecipeListAdapter.OnRecipeDeleteListener {
    ...
    public void onRecipeClick(Recipe recipe) {
        ...
        EditRecipeDialogFragment dialog = new EditRecipeDialogFragment(recipe, updatedRecipe -> {
