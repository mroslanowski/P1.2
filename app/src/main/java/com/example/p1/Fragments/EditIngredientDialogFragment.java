...
public class EditIngredientDialogFragment extends BottomSheetDialogFragment {
    ...
    public EditIngredientDialogFragment(Ingredient ingredient, UpdateCallback updateCallback) {
