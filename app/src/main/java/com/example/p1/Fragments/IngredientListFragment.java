...
import java.util.List;public class IngredientListFragment extends Fragment {
    ...
    private void onIngredientClick(Ingredient ingredient) {
        EditIngredientDialogFragment dialog = new EditIngredientDialogFragment(ingredient, updatedIngredient -> {
            fetchIngredientsFromDatabase();
        });
